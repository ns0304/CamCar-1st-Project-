					...
					<section id="basicInfoArea">
						<table border="1">
							<tr>
								<th width="280">제 목</th>
							<tr>
								<td width="400" align="center">${bo.bo_subject}</td>
							<tr></tr>
							<tr>
								<th width="280">작성일시</th>
							</tr>
							<tr>
								<td width="400" align="center"><fmt:formatDate
										value="${bo.bo_sysdate}" pattern="yyyy-MM-dd HH:mm" /></td>
							</tr>
							<tr>
								<th width="280">공지사항 첨부사진</th>
							</tr>
							<tr>
								<td class="write_td_right" colspan="2">${bo.bo_file}
									<div>
										<img
							...
							<tr>
								<th width="280">공지사항 내용</th>
							</tr>
							<tr>
								<td width="400" align="center" height="480">${bo.bo_content}</td>
							</tr>
						</table>
						<br>
					</section>
					<section id="commandCell">
						...
						<c:if test="${not empty sessionScope.sId}">
							<input type="button" value="수정"
								onclick="location.href='BoardModify?bo_idx=${bo.bo_idx}&pageNum=${param.pageNum}'">
