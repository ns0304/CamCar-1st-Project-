...
<div id ="campingSet2">
	<div class="campingSet2Btn">
		<button id="campingSet2_1" class="campingSet2BtnIn">
			<img
				src="${pageContext.request.servletContext.contextPath}/resources/img/add_item/basic/carseats/carseats_1.png"
	...
	<div class="campingSet2Btn">
		<button id="campingSet2_2" class="campingSet2BtnIn">
		    <img src="${pageContext.request.servletContext.contextPath}/resources/img/add_item/basic/carseats/carseats_2.png" alt="Camping Set"><br>
   		    스노우라인 블랙에디션<br>
		    테이블(2인용) + 릴렉스체어 2개<br>
		    일 12,000원<br>
		</button><br>
	...
	<div class="campingSet2Btn">
		<button id="campingSet2_2" class="campingSet2BtnIn">
		    <img src="${pageContext.request.servletContext.contextPath}/resources/img/add_item/basic/carseats/carseats_3.png" alt="Camping Set"><br>
   		    스노우라인 블랙에디션<br>
		    테이블(2인용) + 릴렉스체어 2개<br>
		    일 12,000원<br>
		</button><br>
