...
<div id ="campingSet3">
	<div class="campingSet3Btn">
		<button id="campingSet3_1" class="campingSet3BtnIn">
			<img
				src="${pageContext.request.servletContext.contextPath}/resources/img/add_item/camp/set/set2_1.jpg"
	...
	<div class="campingSet3Btn">
		<button id="campingSet3_2" class="campingSet2BtnIn">
