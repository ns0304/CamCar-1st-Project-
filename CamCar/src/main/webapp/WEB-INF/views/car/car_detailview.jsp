		...
		<section id="basicInfoArea">
			<table border="1" class="graph">
							...
							<tr>
								...
								<td class="write_td_right" colspan="2">
									${car.car_image1}
									<div><img src="${pageContext.request.contextPath}/resources/upload/${car.car_image1}" id="img1" class="changeImg" selected></div>
								</td>
							</tr>
							<tr>
								<th>차량 사진2</th>
								<td class="write_td_right" colspan="2">
									${car.car_image2}
									<div><img src="${pageContext.request.contextPath}/resources/upload/${car.car_image2}" id="img2" class="changeImg"></div>
								</td>
							</tr>
							<tr>
								<th>차량 사진3</th>
								<td class="write_td_right" colspan="2">
									${car.car_image3}
									<div><img src="${pageContext.request.contextPath}/resources/upload/${car.car_image3}" id="img3" class="changeImg"></div>
								</td>
							</tr>
							<tr>
								<th>차량 사진4</th>
								<td class="write_td_right" colspan="2">
									${car.car_image4}
									<div><img src="${pageContext.request.contextPath}/resources/upload/${car.car_image4}" id="img4" class="changeImg"></div>
								</td>
							</tr>
							<tr>
								<th>차량 사진5</th>
								<td class="write_td_right" colspan="2">
									${car.car_image5}
									<div><img src="${pageContext.request.contextPath}/resources/upload/${car.car_image5}" id="img5" class="changeImg"></div>
								</td>
							</tr>
						</table>
